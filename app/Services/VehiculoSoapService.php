...
class VehiculoSoapService
{
     ...
     * 
     * @var VehiculoWebServiceHealthCheck
     */
     ...
     * @param VehiculoWebServiceHealthCheck|null $healthCheck
     * @param MockVehiculoService|null $mockService
     */
