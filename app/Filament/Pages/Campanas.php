...
class Campanas extends Page
{
            ...
            foreach ($campanas as $campana) {
                try {
                    ...
                    $campanasTransformadas->push([
                        ...
                        'brand' => $campana->brand, // Añadir el campo brand
    ...
    public function filtrarCampanas(): Collection
    {
        return $this->campanas->filter(function ($campana) {
            ...
            $pasaFiltroMarca = empty($this->filtroMarca) || $campana['brand'] === $this->filtroMarca;
            ...
            return $pasaFiltroCiudad && $pasaFiltroEstado && $pasaFiltroMarca && $pasaFiltroBusqueda && $pasaFiltroFechas;
        });
    }
    ...
    {
        $this->reset(['ciudadSeleccionada', 'estadoSeleccionado', 'busqueda', 'rangoFechas', 'fechaInicio', 'fechaFin', 'filtroMarca']);
        $this->resetPage();
        $this->cargarCampanas();
    }
