...
class GestionTiposMantenimiento extends Page
{
    ...
    public function getTiposPaginadosProperty(): LengthAwarePaginator
    {
        ...
        if (! empty($this->busqueda)) {
            ...
            $tiposFiltrados = $tiposFiltrados->filter(function ($tipo) use ($terminoBusqueda) {
        ...
        if (! empty($this->filtroMarca)) {
            $tiposFiltrados = $tiposFiltrados->filter(function ($tipo) {
                return $tipo['brand'] === $this->filtroMarca;
            });
        }
    ...
    public function guardarTipo(): void
    {
        try {
            $this->validate([
                ...
                'tipoEnEdicion.brand' => 'required|in:Toyota,Lexus,Hino',
                ...
                'tipoEnEdicion.brand.required' => 'La marca es obligatoria',
                'tipoEnEdicion.brand.in' => 'La marca debe ser Toyota, Lexus o Hino',
            ...
            $tipo->brand = $this->tipoEnEdicion['brand'];
