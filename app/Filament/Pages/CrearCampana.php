...
class CrearCampana extends Page
{
    ...
    public string $marcaCampana = 'Toyota';
    ...
    private function cargarDatosCampana(): void
    {
        try {
            ...
            $this->marcaCampana = $campana->brand ?? 'Toyota'; // Cargar la marca
    ...
    public function siguientePaso(): void
    {
        ...
        if ($this->pasoActual === 1) {
            $this->validate([
                ...
                'marcaCampana' => 'required|in:Toyota,Lexus,Hino',
            ], [
                ...
                'marcaCampana.required' => 'La marca es obligatoria',
                'marcaCampana.in' => 'La marca debe ser Toyota, Lexus o Hino',
            ]);
        }
    ...
    public function finalizarCreacion(): void
    {
        try {
            ...
            $datosCampana = [
                ...
                'brand' => $this->marcaCampana, // Añadir el campo marca
            ];
