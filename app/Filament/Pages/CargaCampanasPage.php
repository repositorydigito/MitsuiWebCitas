...
class CargaCampanasPage extends Page
{
    ...
    public function descargarPlantilla(): void
    {
        try {
            ...
            $sheet->setCellValue('F1', 'Fecha de Fin');
            ...
            $sheet->setCellValue('D2', 'Toyota');
            $sheet->setCellValue('E2', '2023-12-01');
            $sheet->setCellValue('F2', '2024-02-28');
            ...
            $sheet->setCellValue('D3', 'Lexus');
            $sheet->setCellValue('E3', '2023-11-15');
            $sheet->setCellValue('F3', '2024-01-15');
            $sheet->setCellValue('G3', 'Activo');
    ...
    public function procesarArchivo(): void
    {
        ...
        try {
            ...
            $cabeceras = $rows[0];
            $cabecerasEsperadas = ['Codigo Campaña', 'Campaña', 'Local', 'Marca', 'Fecha de Inicio', 'Fecha de Fin', 'Estado'];
            ...
            $indiceMarca = array_search('marca', $cabecerasNormalizadas);
            ...
            for ($i = 1; $i < count($rows); $i++) {
                ...
                if (empty($campana['marca'])) {
                    $erroresFila[] = 'La marca es obligatoria';
                } elseif (! in_array($campana['marca'], ['Toyota', 'Lexus', 'Hino'])) {
                    $erroresFila[] = 'La marca debe ser Toyota, Lexus o Hino';
                }
    ...
    public function guardarCampanas(): void
    {
        ...
        try {
            ...
            foreach ($this->campanasProcesadas as $index => $campana) {
                ...
                $nuevaCampana->brand = $campana['marca']; // Añadir el campo marca
