    ...
    <div class="space-y-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300"><?php echo e($userData['nombres']); ?></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="py-3 w-40">
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300"><?php echo e($userData['apellidos']); ?></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="py-3 w-40">
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300">
                                            <span class="inline-flex items-center">
                                                ...
                                                <?php echo e($userData['celular'] ?: 'No registrado'); ?>
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300">
                                            <span class="inline-flex items-center">
                                                ...
                                                <?php echo e($userData['correo'] ?: 'No registrado'); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300"><?php echo e($userData['tipo_documento'] ?: 'No registrado'); ?></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="py-3 w-40">
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300"><?php echo e($userData['numero_documento'] ?: 'No registrado'); ?></p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <?php else: ?>
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
                    ...
                    <div class="flex justify-center">
                        <div class="relative flex items-center w-full max-w-md">
                            ...
                            <div class="flex flex-col items-center flex-1">
                                <div class="rounded-full transition duration-500 ease-in-out h-10 w-10 flex items-center justify-center <?php echo e($pasoActual == 1 ? 'bg-primary-600 text-white' : 'bg-gray-300'); ?> z-10">
                            ...
                            <div class="flex-auto border-t-2 transition duration-500 ease-in-out <?php echo e($pasoActual >= 2 ? 'border-primary-600' : 'border-gray-300'); ?> -mx-2 absolute left-0 right-0 top-5 z-0" style="width: 33%;left: 33%;"></div>

                            <!-- Paso 2 -->
                            <div class="flex flex-col items-center flex-1">
                                <div class="rounded-full transition duration-500 ease-in-out h-10 w-10 flex items-center justify-center <?php echo e($pasoActual == 2 ? 'bg-primary-600 text-white' : 'bg-gray-300'); ?> z-10">
                            ...
                            <div class="flex-auto border-t-2 transition duration-500 ease-in-out <?php echo e($pasoActual >= 3 ? 'border-primary-600' : 'border-gray-300'); ?> -mx-2 absolute right-0 top-5 z-0" style="width: 33%;"></div>

                            <!-- Paso 3 -->
                            <div class="flex flex-col items-center flex-1">
                                <div class="rounded-full transition duration-500 ease-in-out h-10 w-10 flex items-center justify-center <?php echo e($pasoActual == 3 ? 'bg-primary-600 text-white' : 'bg-gray-300'); ?> z-10">
                ...
                <div class="p-6">
                    <!--[if BLOCK]><![endif]--><?php if($pasoActual == 1): ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                >
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['datosEdicion.nombres'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                <input
                                    ...
                                    class="w-full px-3 py-2 border border-primary-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
                                >
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['datosEdicion.apellidos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                >
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['datosEdicion.correo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-primary-500 text-xs">Formato inválido</span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            ...
                            <div>
                                ...
                                >
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['datosEdicion.celular'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-primary-500 text-xs">Formato inválido</span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                <select
                                    ...
                                    class="w-full px-3 py-2 border border-primary-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
                                >
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tiposDocumento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </select>
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['datosEdicion.tipo_documento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs">Formato inválido</span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            ...
                            <div>
                                ...
                                >
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['datosEdicion.numero_documento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs">Formato invalido</span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            ...
                            <table class="min-w-full">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="py-2 px-4">
                                            <p class="text-base text-gray-700 dark:text-gray-300"><?php echo e($datosEdicion['nombres']); ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="py-2">
                                        ...
                                        <td class="py-2 px-4">
                                            <p class="text-base text-gray-700 dark:text-gray-300"><?php echo e($datosEdicion['apellidos']); ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="py-2">
                                        ...
                                        <td class="py-2 px-4">
                                            <p class="text-base text-gray-700 dark:text-gray-300">
                                                <span class="inline-flex items-center">
                                                    ...
                                                    <?php echo e($datosEdicion['correo']); ?>
                                        ...
                                        <td class="py-2 px-4">
                                            <p class="text-base text-gray-700 dark:text-gray-300">
                                                <span class="inline-flex items-center">
                                                    ...
                                                    <?php echo e($datosEdicion['celular']); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-4">
                                            <p class="text-base text-gray-700 dark:text-gray-300"><?php echo e($datosEdicion['tipo_documento']); ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="py-2">
                                        ...
                                        <td class="py-2 px-4">
                                            <p class="text-base text-gray-700 dark:text-gray-300"><?php echo e($datosEdicion['numero_documento']); ?></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    <?php elseif($pasoActual == 3): ?>
                        <!-- Paso 3: Confirmación -->
...
<?php endif; ?>
<?php /**PATH /var/www/projects/mitsui/resources/views/filament/pages/mi-cuenta.blade.php ENDPATH**/ ?>