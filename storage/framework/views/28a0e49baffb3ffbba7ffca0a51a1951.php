...
<body>
    ...
    <div class="content">
        ...
        <!-- <?php if(!empty($cambiosRealizados)): ?>
        <div class="changes-section">
            <div class="info-label">🔄 Cambios Realizados:</div>
            <?php $__currentLoopData = $cambiosRealizados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campo => $cambio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="info-value">
                    <strong><?php echo e($campo); ?>:</strong> <?php echo e($cambio['anterior']); ?> → <strong style="color: #28a745;"><?php echo e($cambio['nuevo']); ?></strong>
                </div>
...
</html><?php /**PATH /var/www/projects/mitsui/resources/views/emails/cita-editada.blade.php ENDPATH**/ ?>