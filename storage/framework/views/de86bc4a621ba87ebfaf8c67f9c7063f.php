    ...
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <div class="p-6 flex flex-row items-center w-full justify-start gap-x-4">
            ...
            <div class="flex items-center">
                <img src="<?php echo e(asset('images/logo_Mitsui_Blanco.png')); ?>" alt="logoMitsui" style="margin-right:20px; width: 12rem; height: auto;">
            </div>
...
<?php /**PATH /var/www/projects/mitsui/resources/views/customFooter.blade.php ENDPATH**/ ?>