        ...
        <div class="rounded-lg w-full">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-2 mb-2">
                <button type="button"
                    ...
                    <?php if(!empty($citasAgendadas) && count($citasAgendadas) > 0): echo 'disabled'; endif; ?>
                    class="px-4 py-2 rounded-md w-auto focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 <?php echo e(!empty($citasAgendadas) && count($citasAgendadas) > 0 ? 'bg-gray-400 text-white cursor-not-allowed' : 'bg-primary-500 text-white hover:bg-primary-700'); ?>">
                    Agendar cita
                </button>
            </div>
                ...
                <div x-show="expanded"
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 space-y-4">
                        <div class="flex justify-between">
                            ...
                            <div class="text-gray-800"><?php echo e($vehiculo['modelo'] ?? 'No disponible'); ?></div>
                        </div>

                        <div class="flex justify-between">
                            <div class="w-32 font-bold text-blue-900">Kilometraje</div>
                            <div class="text-gray-800"><?php echo e($vehiculo['kilometraje'] ?? 'No disponible'); ?></div>
                        </div>

                        <div class="flex justify-between">
                            <div class="w-32 font-bold text-blue-900">Placa</div>
                            <div class="text-gray-800"><?php echo e($vehiculo['placa'] ?? 'No disponible'); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4">
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between">
                                ...
                                <div class="text-gray-800"><?php echo e($mantenimiento['vencimiento']); ?></div>
                            </div>

                            <div class="flex justify-between items-start">
                                <div class="w-32 font-bold text-blue-900">Disponibles</div>
                                <div class="text-gray-800">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $mantenimiento['disponibles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disponible): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div><?php echo e($disponible); ?></div>
            ...
            <div class="mb-4" x-data="{ expanded: true }">
                ...
                <div x-show="expanded"
                     ...
                     x-transition:leave-end="opacity-0 transform -translate-y-2"
                     class="space-y-4">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $citasAgendadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white border border-gray-200 rounded-lg p-4">
                                    ...
                                    <div class="bg-gray-50 p-3 rounded-lg">
                                        ...
                                        <div class="flex flex-row justify-between gap-2">
                                            ...
                                            <div style="display: flex; flex-direction: column; align-items: center;">
                                                <div style="width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background-color: <?php echo e($citaCompletada ? '#059669' : '#d1d5db'); ?>;">
                                                    <!--[if BLOCK]><![endif]--><?php if($citaCompletada): ?>
                                                ...
                                                <span style="font-size: 12px; font-weight: 500; margin-top: 4px; text-align: center; color: <?php echo e($citaCompletada ? '#059669' : '#6b7280'); ?>;">
                                                    Cita confirmada
                                                </span>
                                            </div>
                                            ...
                                            ?>
                                            <div style="display: flex; flex-direction: column; align-items: center; opacity: <?php echo e($trabajoCompletado ? '1' : '0.5'); ?>;">
                                                <div style="width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background-color: <?php echo e($trabajoActivo ? '#2563eb' : ($trabajoCompletado ? '#059669' : '#d1d5db')); ?>;">
                                                    <!--[if BLOCK]><![endif]--><?php if($trabajoCompletado): ?>
                                                        <svg style="width: 20px; height: 20px; color: white;" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                                        </svg>
                                                    <?php else: ?>
                                                ...
                                                <span style="font-size: 12px; font-weight: 500; margin-top: 4px; text-align: center; color: <?php echo e($trabajoActivo ? '#2563eb' : ($trabajoCompletado ? '#059669' : '#6b7280')); ?>;">
                                                    En trabajo
                                                </span>
                                            </div>
                                            ...
                                            ?>
                                            <div style="display: flex; flex-direction: column; align-items: center; opacity: <?php echo e($concluidoCompletado ? '1' : '0.5'); ?>;">
                                                <div style="width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background-color: <?php echo e($concluidoActivo ? '#2563eb' : ($concluidoCompletado ? '#059669' : '#d1d5db')); ?>;">
                                                    <!--[if BLOCK]><![endif]--><?php if($concluidoCompletado): ?>
                                                        <svg style="width: 20px; height: 20px; color: white;" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                                        </svg>
                                                    <?php else: ?>
                                                ...
                                                <span style="font-size: 12px; font-weight: 500; margin-top: 4px; text-align: center; color: <?php echo e($concluidoActivo ? '#2563eb' : ($concluidoCompletado ? '#059669' : '#6b7280')); ?>;">
                                                    Trabajo concluido
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="bg-blue-50 p-3 rounded-lg">
                                        <div class="space-y-2">
                                            ...
                                            <div class="flex justify-between items-center">
                                                ...
                                                <span class="text-xs text-gray-600 mt-1"><?php echo e($cita['fecha_cita']); ?></span>
                                            </div>

                                            <div class="flex justify-between items-center">
                                                <span class="text-xs font-medium text-blue-800">Hora de la cita:</span
                                                <span class="text-xs text-gray-600 mt-1"><?php echo e($cita['hora_cita'] ?? ''); ?></span>
                                            </div>

                                            <div class="flex justify-between items-center">
                                                <span class="text-xs font-medium text-blue-800">Servicio:</span>
                                                <span class="text-xs text-gray-600 mt-1">Mantenimiento <?php echo e($cita['servicio'] ?? 'Servicio programado'); ?></span>
                                            </div>

                                            <div class="flex justify-between items-center">
                                                <span class="text-xs font-medium text-blue-800">Sede:</span>
                                                <span class="text-xs text-gray-600"><?php echo e($cita['sede'] ?? '-'); ?></span>
                                            </div>

                                            <!--[if BLOCK]><![endif]--><?php if(($trabajoActivo || $trabajoCompletado) || ($concluidoActivo || $concluidoCompletado)): ?>
                                            <br>

                                            <div class="flex justify-between">
                                                <span class="text-xs font-medium text-blue-800">Fecha de entrega:</span>
                                                <span class="text-xs text-gray-600"><?php echo e($cita['probable_entrega'] ?? '-'); ?></span>
                                            </div>

                                            <div class="flex justify-between">
                                                <span class="text-xs font-medium text-blue-800">Asesor:</span>
                                                <span class="text-xs text-gray-600"><?php echo e($cita['asesor'] ?? 'Por asignar'); ?></span>
                                            </div>

                                            <div class="flex justify-between">
                                                <span class="text-xs font-medium text-blue-800">WhatsApp:</span>
                                                <span class="text-xs text-gray-600">
                                                    <!--[if BLOCK]><![endif]--><?php if(!empty($cita['whatsapp']) && $cita['whatsapp'] !== '-'): ?>
                                                        <a href="https://wa.me/<?php echo e(str_replace(['+', ' ', '-'], '', $cita['whatsapp'])); ?>"
                                                           target="_blank" class="text-green-600 hover:text-green-800">
                                                            <?php echo e($cita['whatsapp']); ?>
                                            ...
                                            <div class="flex justify-between">
                                                ...
                                                <span class="text-xs text-gray-600">
                                                    <!--[if BLOCK]><![endif]--><?php if(!empty($cita['correo'])): ?>
                                                        <a href="mailto:<?php echo e($cita['correo']); ?>" class="text-blue-600 hover:text-blue-800">
                                                            <?php echo e($cita['correo']); ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(($concluidoActivo || $concluidoCompletado) && !empty($cita['fecha_factura'])): ?>
                                            <br>
                                            ...
                                            <div class="flex justify-between items-center">
                                                ...
                                                <span class="text-xs text-gray-600"><?php echo e($cita['fecha_factura'] ?? '-'); ?></span>
                                            </div>

                                            <div class="flex justify-between items-center">
                                                <span class="text-xs font-medium text-green-800">Hora de factura:</span>
                                                <span class="text-xs text-gray-600"><?php echo e($cita['hora_factura'] ?? '-'); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            ...
                            <div class="mt-4 pt-3 border-t border-gray-200">
                                <div class="flex flex-row md:justify-end gap-2 md:gap-4">
                                    <!--[if BLOCK]><![endif]--><?php if($concluidoCompletado && !empty($cita['rut_pdf'])): ?>
                                        <a href="<?php echo e($cita['rut_pdf']); ?>" target="_blank" class="text-gray-600 hover:text-primary-800 flex items-center justify-center md:justify-start text-sm py-2 rounded-md hover:bg-primary-50">
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <button type="button" wire:click="editarCita(<?php echo e(json_encode($cita, JSON_HEX_APOS | JSON_HEX_QUOT)); ?>)" onclick="console.log('🔧 Botón Editar clickeado:', <?php echo json_encode($cita, 15, 512) ?>)" class="text-primary-600 hover:text-primary-800 flex items-center justify-center md:justify-start text-sm py-2 rounded-md hover:bg-primary-50">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($puedeAnular): ?>
                                        <button type="button" 
                                                wire:click="anularCita(<?php echo e(json_encode($cita, JSON_HEX_APOS | JSON_HEX_QUOT)); ?>)"
                                    ...
                                    <?php else: ?>
                                        <button type="button" 
                                                ...
                                                title="No se puede anular una cita en estado <?php echo e($cita['estado'] ?? 'desconocido'); ?>">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div x-data="{ expanded: true }">
                ...
                <div x-show="expanded"
                    ...
                    <div class="hidden md:block">
                        <table class="w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->historialPaginado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servicio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900">
                                            <?php echo e($servicio['fecha']); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900">
                                            <?php echo e($servicio['sede']); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900">
                                            <?php echo e($servicio['asesor']); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900">
                                            <?php echo e($servicio['tipo_pago']); ?>
                    ...
                    <div class="md:hidden space-y-4">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->historialPaginado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $servicio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white border border-gray-200 rounded-lg overflow-hidden" x-data="{ expanded: false }">
                                ...
                                <div class="p-4 cursor-pointer hover:bg-gray-50" @click="expanded = !expanded">
                                    <div class="flex justify-between items-center">
                                        <div>
                                            <div class="text-gray-800 font-semibold"><?php echo e($servicio['servicio']); ?></div>
                                        </div>
                                     ...
                                     <div class="px-4 pb-4 space-y-3 border-t border-gray-100">
                                        <div class="bg-gray-50 p-3 rounded-lg">
                                            <div class="flex flex-row justify-between">
                                                ...
                                                <div class="text-sm text-gray-800"><?php echo e($servicio['fecha']); ?></div>
                                            </div>
                                            <div class="flex flex-row justify-between">
                                                <div class="text-sm font-medium text-primary-800 mb-1">Sede</div>
                                                <div class="text-sm text-gray-800"><?php echo e($servicio['sede']); ?></div>
                                            </div>
                                            <div class="flex flex-row justify-between">
                                                <div class="text-sm font-medium text-primary-800 mb-1">Asesor</div>
                                                <div class="text-sm text-gray-800"><?php echo e($servicio['asesor']); ?></div>
                                            </div>
                                            <div class="flex flex-row justify-between">
                                                <div class="text-sm font-medium text-primary-800 mb-1">Tipo de pago</div>
                                                <div class="text-sm text-gray-800"><?php echo e($servicio['tipo_pago']); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    if (typeof Swal !== 'undefined') {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('confirmarAnulacion', uuid, citaData);
                            }
                        });
                    } else {
...
<?php endif; ?>
</div><?php /**PATH /var/www/projects/mitsui/resources/views/filament/pages/detalle-vehiculo.blade.php ENDPATH**/ ?>