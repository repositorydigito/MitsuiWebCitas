...
<?php $component->withAttributes([]); ?>
    <div>
        ...
        <div class="mb-2 flex items-center justify-between w-full">
            <div>
                <a href="<?php echo e(route('filament.admin.pages.home')); ?>"
            ...
            <div>
                ...
                <span class="font-semibold flex justify-center"><?php echo e($puntosClubMitsui ?? '0'); ?> pts</span>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="lg:hidden space-y-4">
                ...
                <div class="w-full">
                    <a href="<?php echo e(\App\Filament\Pages\AgregarVehiculo::getUrl()); ?>" class="inline-flex w-full items-center justify-center px-4 py-2 text-sm font-medium text-primary-500 bg-white border border-primary-500 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
            ...
            <div class="hidden lg:flex flex-wrap gap-4 items-center justify-between">
                ...
                <div class="flex gap-2">
                    <a href="<?php echo e(\App\Filament\Pages\AgregarVehiculo::getUrl()); ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium text-primary-500 bg-white border border-primary-500 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
                        <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                        </svg>
                        Agregar vehículo
        ...
        <div class="lg:hidden relative flex justify-center">
            <div class="overflow-x-auto scrollbar-hide pb-1">
                <div class="flex whitespace-nowrap border-b border-gray-200 min-w-full">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $marcasInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $codigo => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button
                            wire:click="selectTab('<?php echo e($codigo); ?>')"
                            class="px-4 py-2 mb-4 text-sm font-medium flex-shrink-0 <?php echo e($activeTab === $codigo ? 'border rounded-lg border-primary-500 font-semibold text-primary-600' : 'text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>"
                        >
                            <?php echo e($nombre); ?>

                            <!--[if BLOCK]><![endif]--><?php if(isset($marcaCounts[$codigo]) && $marcaCounts[$codigo] > 0): ?>
                                <span class="ml-1 px-1.5 py-0.5 text-xs rounded-full bg-gray-100 text-gray-700"><?php echo e($marcaCounts[$codigo]); ?></span>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </button>
        ...
        <div class="hidden lg:block">
            <div class="flex border-b border-gray-200">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $marcasInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $codigo => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button
                        wire:click="selectTab('<?php echo e($codigo); ?>')"
                        class="px-6 py-3 text-sm font-medium <?php echo e($activeTab === $codigo ? 'border-b-2 border-primary-500 text-primary-600' : 'text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>"
                    >
                        <?php echo e($nombre); ?>

                        <!--[if BLOCK]><![endif]--><?php if(isset($marcaCounts[$codigo]) && $marcaCounts[$codigo] > 0): ?>
                            <span class="ml-2 px-2 py-0.5 text-xs rounded-full bg-gray-100 text-gray-700"><?php echo e($marcaCounts[$codigo]); ?></span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
            </div>
    ...
    <div>
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $marcasInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $codigo => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div
                wire:key="tab-content-<?php echo e($codigo); ?>"
            >
                
                <?php if($activeTab === $codigo): ?>
                    <?php
                        $currentPaginator = $this->vehiculosPaginados;
                        $marcaActual = $this->marcasInfo[$codigo] ?? 'Desconocida';
                    ?>

                    <!--[if BLOCK]><![endif]--><?php if($currentPaginator && $currentPaginator->total() > 0): ?>

                    
                        <div class="lg:hidden space-y-4 mb-4">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $currentPaginator->items(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehiculo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex items-start mb-3 justify-between">
                                            <div class="flex items-center">
                                                <div class="h-16 w-20 rounded overflow-hidden bg-gray-100 dark:bg-gray-700 flex items-center justify-center border border-gray-200 dark:border-gray-600 mr-3">
                                                    <!--[if BLOCK]><![endif]--><?php if(isset($vehiculo['foto_url'])): ?>
                                                        <img src="<?php echo e($vehiculo['foto_url']); ?>" alt="Vehículo <?php echo e($vehiculo['modver']); ?>" class="h-full w-full object-cover">
                                                    <?php elseif(!empty($vehiculo['modelo_image_url'])): ?>
                                                        <img src="<?php echo e($vehiculo['modelo_image_url']); ?>" alt="Modelo <?php echo e($vehiculo['modver']); ?>" class="h-full w-full object-cover">
                                                    <?php elseif(Str::contains($vehiculo['modver'], 'COROLLA CROSS')): ?>
                                                        <img src="<?php echo e(asset('images/CorollaCross.jpeg')); ?>" alt="Vehículo <?php echo e($vehiculo['modver']); ?>" class="h-full w-full object-cover">
                                                    <?php elseif(Str::contains($vehiculo['modver'], 'ETIOS')): ?>
                                                        <img src="<?php echo e(asset('images/Etios.jpeg')); ?>" alt="Vehículo <?php echo e($vehiculo['modver']); ?>" class="h-full w-full object-cover">
                                                    <?php elseif(Str::contains($vehiculo['modver'], 'YARIS CROSS')): ?>
                                                        <img src="<?php echo e(asset('images/YarisCross.jpeg')); ?>" alt="Vehículo <?php echo e($vehiculo['modver']); ?>" class="h-full w-full object-cover">
                                                    <?php else: ?>
                                                    <div class="text-center p-1">
                                                        <img src="<?php echo e(asset('images/no-image.svg')); ?>" alt="Sin imagen" class="h-10 w-10 mx-auto">
                                                ...
                                                <div class="px-4">
                                                    <h3 class="text-base font-bold text-gray-900 dark:text-white">
                                                        <?php echo e($vehiculo['modver']); ?>

                                                    </h3>
                                                    <div class="text-sm font-medium text-gray-600 dark:text-gray-300">
                                                        Placa: <?php echo e($vehiculo['numpla'] ?? 'No disponible'); ?>

                                                    </div>
                                                    <div class="text-sm text-gray-600 dark:text-gray-300">
                                                        Año: <?php echo e($vehiculo['aniomod']); ?>
                                            ...
                                            <div class="flex-shrink-0 mr-4">
                                                ...
                                                ?>
                                                <div style="width: 16px; height: 16px; border-radius: 50%; background-color: <?php echo e($tieneCitaAgendada ? '#1AAB40' : '#9ca3af'); ?>;"
                                                     title="<?php echo e($tieneCitaAgendada ? 'Cita agendada' : 'Sin cita agendada'); ?>">
                                                </div>
                                            </div>
                                        </div>

                                        <div class="flex flex-cols-3 justify-between gap-2 mt-3">
                                            <!--[if BLOCK]><![endif]--><?php if($tieneCitaAgendada): ?>
                                                <!-- Si tiene cita agendada: Ver detalle es primario, Agendar cita y Retirar son secundarios y deshabilitados -->
                                                <a href="<?php echo e(\App\Filament\Pages\DetalleVehiculo::getUrl(['vehiculoId' => $vehiculo['numpla'] ?? ''])); ?>" class="flex-1 gap-1 inline-flex items-center justify-center px-2 py-1.5 text-xs font-medium text-white bg-primary-600 border border-transparent rounded hover:bg-primary-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <a href="<?php echo e(\App\Filament\Pages\DetalleVehiculo::getUrl(['vehiculoId' => $vehiculo['numpla'] ?? ''])); ?>" class="flex-1 gap-1 inline-flex items-center justify-center px-2 py-1.5 text-xs font-medium text-primary-500 bg-white border border-primary-500 rounded hover:bg-gray-50 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
                                                    <svg class="w-3 h-3 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                        <path fill-rule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clip-rule="evenodd" />
                                                    </svg>
                                                    Ver detalle
                                                ...
                                                <button
                                                    wire:click="eliminarVehiculo('<?php echo e($vehiculo['vhclie']); ?>')"
                            ...
                            <div class="px-4 py-4">
                                <?php echo e($currentPaginator->links('custom-pagination')); ?>
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-200 dark:border-gray-700 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <span class="text-sm font-medium text-gray-600 dark:text-gray-300">
                                                    <?php echo e($vehiculo['numpla'] ?? 'No disponible'); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            ...
                                            <div class="inline-flex justify-center">
                                                <div style="width: 12px; height: 12px; border-radius: 50%; background-color: <?php echo e($tieneCitaAgendada ? '#1AAB40' : '#9ca3af'); ?>;"
                                                     title="<?php echo e($tieneCitaAgendada ? 'Cita agendada' : 'Sin cita agendada'); ?>">
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex flex-wrap gap-2 justify-end">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($tieneCitaAgendada): ?>
                                                    <!-- Si tiene cita agendada: Ver detalle es primario, Agendar cita y Retirar son secundarios y deshabilitados -->
                                                    <a href="<?php echo e(\App\Filament\Pages\DetalleVehiculo::getUrl(['vehiculoId' => $vehiculo['numpla'] ?? ''])); ?>" class="inline-flex items-center justify-center w-32 gap-2 py-1 text-xs font-medium text-white bg-primary-600 border border-transparent rounded hover:bg-primary-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
                                                        <svg class="w-3 h-3 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                            <path fill-rule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clip-rule="evenodd" />
                                                        </svg>
                                                        Ver detalle
                                            ...
                                            <?php else: ?>
                                                <!-- Si no tiene cita: Ver detalle es secundario, Agendar cita es primario -->
                                                <a href="<?php echo e(\App\Filament\Pages\DetalleVehiculo::getUrl(['vehiculoId' => $vehiculo['numpla'] ?? ''])); ?>" class="inline-flex items-center justify-center w-32 gap-2 py-1 text-xs font-medium text-primary-500 bg-white rounded hover:bg-gray-50 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
                                                    <svg class="w-3 h-3 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                        <path fill-rule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clip-rule="evenodd" />
                                                    </svg>
                                                    Ver detalle
                                                ...
                                                <a href="<?php echo e(route('filament.admin.pages.agendar-cita', ['vehiculoId' => $vehiculo['vhclie'] ?? ''])); ?>" class="inline-flex items-center justify-center w-32 gap-2 py-1 text-xs font-medium text-white bg-primary-600 border border-transparent rounded hover:bg-primary-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
                                                    <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                        <path fill-rule="evenodd" d="M5.75 2a.75.75 0 01.75.75V4h7V2.75a.75.75 0 011.5 0V4h.25A2.75 2.75 0 0118 6.75v8.5A2.75 2.75 0 0115.25 18H4.75A2.75 2.75 0 012 15.25v-8.5A2.75 2.75 0 014.75 4H5V2.75A.75.75 0 015.75 2zm-1 5.5c-.69 0-1.25.56-1.25 1.25v6.5c0 .69.56 1.25 1.25 1.25h10.5c.69 0 1.25-.56 1.25-1.25v-6.5c0-.69-.56-1.25-1.25-1.25H4.75z" clip-rule="evenodd" />
                                                    </svg>
                                                    Agendar
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm py-6 px-4 mb-4 w-full text-center">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($search): ?>
                                <p class="text-gray-500 dark:text-gray-400 text-sm max-w-md mx-auto mb-4">
                                    No hay vehículos que coincidan con la búsqueda "<strong><?php echo e($search); ?></strong>" para la marca <?php echo e($marcaActual); ?>.
                                </p>
                                <button
                                    wire:click="limpiarBusqueda"
                            ...
                            <?php else: ?>
                                <p class="text-gray-500 dark:text-gray-400 text-sm max-w-md mx-auto">No hay vehículos registrados para la marca <?php echo e($marcaActual); ?>.</p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <div class="mt-4">
                                <a href="<?php echo e(\App\Filament\Pages\AgregarVehiculo::getUrl()); ?>" class="inline-flex gap-2 items-center px-4 py-2 text-sm font-medium text-primary-500 bg-white border border-primary-500 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1">
                                    <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                                    </svg>
                                    Agregar un vehículo
...
<?php endif; ?>
<?php /**PATH /var/www/projects/mitsui/resources/views/filament/pages/vehiculos-con-pestanas.blade.php ENDPATH**/ ?>