        ...
        <div class="overflow-x-auto rounded-lg">
            <table class="w-full bg-white border border-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $local): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="py-3 px-4 text-sm text-gray-700"><?php echo e($local->code); ?></td>
                            <td class="py-3 px-4 text-sm text-gray-700"><?php echo e($local->name); ?></td>
                            <td class="py-3 px-4 text-sm text-gray-700">
                                <span class="px-2 py-1 rounded-full text-xs font-medium
                                    <?php echo e($local->brand === 'Toyota' ? 'bg-red-100 text-red-800' : ''); ?>

                                    <?php echo e($local->brand === 'Lexus' ? 'bg-blue-100 text-blue-800' : ''); ?>

                                    <?php echo e($local->brand === 'Hino' ? 'bg-green-100 text-green-800' : ''); ?>

                                    <?php echo e(!in_array($local->brand, ['Toyota', 'Lexus', 'Hino']) ? 'bg-gray-100 text-gray-800' : ''); ?>

                                ">
                                    <?php echo e($local->brand ?: '-'); ?>

                                </span>
                            </td>
                            <td class="py-3 px-4 text-sm text-gray-700"><?php echo e($local->address ?: '-'); ?></td>
                            <td class="py-3 px-4 text-sm text-gray-700"><?php echo e($local->phone ?: '-'); ?></td>
                            <!-- <td class="py-3 px-4 text-sm text-gray-700"><?php echo e(substr($local->opening_time, 0, 5)); ?> - <?php echo e(substr($local->closing_time, 0, 5)); ?></td> -->
                            <td class="py-3 px-4 text-sm">
                                <span class="px-2 py-1 rounded-full text-xs <?php echo e($local->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                    <?php echo e($local->is_active ? 'Activo' : 'Inactivo'); ?>
                            ...
                            <td class="py-3 px-4 text-sm text-gray-700">
                                <div class="flex justify-between space-x-2">
                                    <button
                                        wire:click="abrirModal(<?php echo e($local->id); ?>)"
                                    ...
                                    <button
                                        wire:click="toggleEstado(<?php echo e($local->id); ?>)"
                                        class="<?php echo e($local->is_active ? 'text-red-600 hover:text-red-800' : 'text-green-600 hover:text-green-800'); ?>"
                                        title="<?php echo e($local->is_active ? 'Desactivar' : 'Activar'); ?>"
                                    >
                                        <!--[if BLOCK]><![endif]--><?php if($local->is_active): ?>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <button
                                        wire:click="eliminarLocal(<?php echo e($local->id); ?>)"
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{}" x-cloak>
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                >
                    <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-lg font-semibold text-blue-900"><?php echo e($editMode ? 'Editar Local' : 'Nuevo Local'); ?></h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input
                                ...
                                id="code"
                                class="w-full rounded-lg border <?php echo e($errors['code'] ? 'border-red-500' : 'border-primary-500'); ?> text-gray-700 py-2 px-3"
                                placeholder="Ej: local1"
                                <?php echo e($editMode ? 'disabled' : ''); ?>

                            >
                            <!--[if BLOCK]><![endif]--><?php if($errors['code']): ?>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="name"
                                class="w-full rounded-lg border <?php echo e($errors['name'] ? 'border-red-500' : 'border-primary-500'); ?> text-gray-700 py-2 px-3"
                                placeholder="Ej: La Molina"
                            >
                            <!--[if BLOCK]><![endif]--><?php if($errors['name']): ?>
                                <p class="text-primary-500 text-sm mt-1">Elige una opción disponible.</p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <select
                                ...
                                id="brand"
                                class="w-full rounded-lg border <?php echo e($errors['brand'] ? 'border-red-500' : 'border-primary-500'); ?> text-gray-700 py-2 px-3"
                            >
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($errors['brand']): ?>
                    ...
                    <div class="flex justify-center pt-4 border-t gap-4">
                        ...
                        >
                            <?php echo e($editMode ? 'Actualizar' : 'Guardar'); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/projects/mitsui/resources/views/filament/pages/administrar-locales.blade.php ENDPATH**/ ?>