        ...
        @if ($pasoActual === 1)
            <div>
                        ...
                        <div>
                            ...
                            <div x-data="{ open: false, selectedOptions: @entangle('modelosSeleccionados') }" class="relative">
                                ...
                                <div
                                    ...
                                    class="absolute z-10 mt-1 w-full bg-white shadow-lg rounded-lg py-1 text-base ring-1 ring-black ring-opacity-5 overflow-y-auto"
                                    ...
                                    style="max-height: calc(2.5rem * 10); display: none;"
                                >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4 border-t pt-4">
                    ...
                    <!-- Marca de la campaña -->
                    <div>
                        <h2 class="text-lg font-medium text-gray-900 mb-4">Marca</h2>
                        <div class="w-full">
                            <select
                                wire:model="marcaCampana"
                                class="w-full border-gray-300 rounded-lg shadow-sm focus:border-primary-500 focus:ring-primary-500"
                            >
                            ...
                            @error('marcaCampana') <span class="text-primary-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
                    <table class="w-full">
                        <tbody>
                            ...
                            <tr>
                                <td class="px-6 py-3 text-sm font-medium text-primary-600 bg-gray-50">Marca</td>
                                <td class="px-6 py-3 text-sm text-gray-900">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        @if($marcaCampana === 'Toyota') bg-red-100 text-red-800
                                        @elseif($marcaCampana === 'Lexus') bg-blue-100 text-blue-800
