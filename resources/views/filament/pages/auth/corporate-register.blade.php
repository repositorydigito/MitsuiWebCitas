    ...
    <div class="login-container">
        ...
        <div class="left-panel">
            <div class="form-container">
                ...
                <p class="form-subtitle text-center">Completa los datos para registrarte en el sistema</p>
                ...
                <p class="login-link">
                    ¿Ya tienes cuenta? <a href="{{ filament()->getLoginUrl() }}" style="color: #0075BF; text-decoration: none; font-weight: 500;">Inicia sesión aquí</a>
                </p>
            </div>
        </div>
        ...
        <div class="right-panel">
            <div class="right-panel-overlay">
                ...
                <p class="brand-subtitle">Únete a nuestra plataforma integral para la administración de citas y servicios automotrices</p>
            </div>
        </div>
    </div>
