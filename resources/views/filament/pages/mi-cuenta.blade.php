                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <tr>
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300">{{ $usuario['nombres'] }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="py-3 w-40">
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300">{{ $usuario['apellidos'] }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="py-3 w-40">
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300">{{ $usuario['tipo_documento'] }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="py-3 w-40">
                                    ...
                                    <td class="py-3 px-6">
                                        <p class="text-base text-gray-700 dark:text-gray-300">{{ $usuario['numero_documento'] }}</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
