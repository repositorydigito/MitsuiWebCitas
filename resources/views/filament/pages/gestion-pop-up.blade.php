                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500">
                                <div class="flex flex-col items-center justify-center py-6">
                                    ...
                                    <p class="text-gray-500 text-lg font-medium mb-2">No se encontraron pop ups</p>
                                    <p class="text-gray-400 text-sm">Agrega una nueva opción para comenzar</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
            ...
            <div class="relative inline-block bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all max-w-lg w-full z-[9999]" @click.stop>
                ...
                <div class="bg-white px-6 pt-6 pb-6 relative">
                    ...
                    <div class="flex flex-col">
                        <h3 class="text-xl font-bold text-primary-600 text-center mb-4" id="modal-title">
                            {{ $accionFormulario === 'crear' ? 'Agregar nueva opción' : 'Editar opción' }}
                        </h3>
                        ...
                        <form wire:submit.prevent="guardarPopup" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center">
                                    <input type="file" id="imagen" class="sr-only" accept="image/*">
                                    ...
                                    <span class="px-4 text-sm text-gray-500">JPG, PNG, GIF hasta 2MB</span>
                                </div>
                            </div>
