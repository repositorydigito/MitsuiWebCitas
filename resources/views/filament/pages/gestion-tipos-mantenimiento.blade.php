                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    @if($tipo['brand'] === 'Toyota') bg-red-100 text-red-800
                                    @elseif($tipo['brand'] === 'Lexus') bg-blue-100 text-blue-800
        ...
        @if($this->tiposPaginados->hasPages())
            <div class="flex justify-center">
                <nav class="flex items-center gap-1 sm:gap-2">
                    ...
                    @php
                        $currentPage = $this->tiposPaginados->currentPage();
                        $lastPage = $this->tiposPaginados->lastPage();
                        $showPages = [];
                            ...
                            <div class="flex flex-col space-y-4">
                                ...
                                <div class="flex md:flex-row flex-col justify-between gap-2">
                                    ...
                                    <div class="flex flex-col w-full">
                                        ...
                                        <select
                                            id="brand"
                                            wire:model="tipoEnEdicion.brand"
                                            class="border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                        >
                                            <option value="Toyota">Toyota</option>
                                            <option value="Lexus">Lexus</option>
                                        ...
                                        @error('tipoEnEdicion.brand') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                    </div>
